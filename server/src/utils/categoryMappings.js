...
export const categoryKeywords = {
  ...
  Travel: [
    ...
    'iocl', 'fuel', 'shell', 'toll', 'fastag', 'cab', 'taxi'
  ],
  Shopping: [
    'amazon', 'flipkart', 'myntra', 'ajio', 'nykaa', 'meesho', 'decathlon', 
    'zara', 'h&m', 'retail', 'clothing', 'electronics', 'appliances', 'mall'
  ],
  Bills: [
  ...
  Subscriptions: [
    ...
    'gym', 'membership', 'canva', 'github', 'openai', 'chatgpt', 'adobe'
  ],
  Salary: [
    'salary', 'payroll', 'stipend', 'wages', 'salary credit', 'acme corp'
  ],
  Rent: [
    'rent', 'house rent', 'pg rent', 'maintenance'
  ],
  Investments: [
